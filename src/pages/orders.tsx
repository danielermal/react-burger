...
import { WS_ORDER_CONNECTION_START, WS_ORDER_CONNECTION_CLOSED } from "../services/constants/wsActions";
...
export const ProfileOrders: FC = () => {
  ...
  const currentOrders = React.useMemo<Array<TOrder>>(() => {
    if (orders) {
      const newOrder = JSON.parse(JSON.stringify(orders)).map((item: TOrder): TOrder => {
